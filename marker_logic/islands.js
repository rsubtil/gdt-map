...
function addIslands(map) {

    // New layer with id `islands` from geoJSON `islands`
    map.addInteractiveLayer('islands', islands, {
        ...
        sidebar_icon_html: '<i class="fas fa-sun-plant-wilt"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon(icon, "islands"),
                riseOnHover: true
            });
        },
    });
