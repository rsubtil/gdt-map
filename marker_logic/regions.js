...
function addRegions(map) {
    ...
    // New layer with id `regions` from geoJSON `regions`
    map.addInteractiveLayer('regions_cavacas', regions_cavacas, {

        // The display name for this layer
        name: 'Regiões - Cavacas',
        ...
        sidebar_icon_html: '<i class="fas fa-flag"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon("fa-flag", "regions"),
                riseOnHover: true
            });
        },
