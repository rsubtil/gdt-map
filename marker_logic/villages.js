...
function addVillages(map) {

    // New layer with id `villages` from geoJSON `villages`
    map.addInteractiveLayer('villages', villages, {
        ...
        sidebar_icon_html: '<i class="fas fa-house-flag"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon(icon, "villages"),
                riseOnHover: true
            });
        },
    });
