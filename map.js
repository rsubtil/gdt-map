...
addDeadzone(interactive_map);
addCountries(interactive_map);
addRegions(interactive_map);
addBiomes(interactive_map);
addMountains(interactive_map);
addWaters(interactive_map);
addIslands(interactive_map);
addVillages(interactive_map);
addPOI(interactive_map);
